...
public class SplashActivityTest3 {
    ...
    public void splashActivityTest3() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.et_registration_name),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Ania"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.et_registration_pass),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("1122"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.et_login_pass),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("11222"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.et_login_pass), withText("11222"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("1122"));

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.et_login_pass), withText("1122"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatTextView2 = onView(
                allOf(withId(android.R.id.title), withText("Создать Заметку"),
                        childAtPosition(
                                childAtPosition(
